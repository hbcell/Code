...
cell_num=1:2;
stimuli_order=[6 3 11 7 10 5 9 2 4 1 8]; %%%%%%%%%%%%%%%%%%编号
...
for i=1:size(focus_name,1)  
    ...
    [calcium_dff,calcium_dff_std,data_new_mean_all_trials_cell,data_new_trials_value]=calcium_plot_all_cell_mean_trace_in_line(results_directory,pathname,cell_num,stimuli_order,focus_name_now,fig_y,Fs_cal,time);    
